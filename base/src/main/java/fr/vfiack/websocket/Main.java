...
public class Main {
    ...
    private static SSLContext createTlsSslContext(KeyStore keyStore, String keyPassword) throws NoSuchAlgorithmException, KeyStoreException, UnrecoverableKeyException, KeyManagementException {
